...
def apply_quantization(image_path, k=0, gaussian_blur_size=0, gaussian_blur_sigma=0,gaussian_noise_std=0):
    # Load the image
...
if __name__ == "__main__":
    ...
    output_folder = r'D:/Overlap 2D Shape 40 Percent process_image_2'
